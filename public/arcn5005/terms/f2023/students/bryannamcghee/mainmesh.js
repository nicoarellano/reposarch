...
const torusKnotRotationSpeed = 30;

const torusKnotGeometry = new THREE.TorusKnotGeometry(30, 3, 100, 16);
const torusKnotMaterial = new THREE.MeshBasicMaterial({ color:  0xADD8E6 });
...
const yellowMaterial = new THREE.MeshLambertMaterial({ color:  0xADD8E6 });

const blueMaterial = new THREE.MeshLambertMaterial({ color:  0xADD8E6 });

const redMaterial = new THREE.MeshLambertMaterial({ color:  0xADD8E6 });

const greenMaterial = new THREE.MeshLambertMaterial({ color: 0xADD8E6 });
