    ...
    map.loadImage(
        ...
        const visit = e.features[0];
            ...
            .setHTML(`
                ...
                <img src="${visit.properties.Image}" alt="${visit.properties.PlaceName}" style="max-width: 100%; height: auto;">
                <p>Location: ${visit.properties.Location}</p>
                <p>Description: ${visit.properties.Description}</p>
                <p>Video: ${visit.properties.Video ? `<a href=${visit.properties.Video}" target="_blank">${visit.properties.Video}</a>` :'Not available'}</p>
                `)
            .addTo(map);
  });
