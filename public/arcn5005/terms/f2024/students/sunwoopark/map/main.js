...
map.on('load', () => {
  ...
  textOverlay.innerHTML = `<strong style="font-size: 16px;">˖°.₊˚☕⊹♡<br>
...
map.on('load', () => {
      ...
      data: {
        ...
        features: [
          // neo bar cafe
          {
            ...
            geometry: {
              type: 'Point',
              coordinates: [-79.394659, 43.64498],
            },
            properties: {
          ...
          // hey happy
          {
            ...
            geometry: {
              type: 'Point',
              coordinates: [-123.36882, 48.42808],
            },
            properties: {
              PlaceName: 'HEY HAPPY',
          ...
          // greenhorn cafe
          {
            ...
            geometry: {
              type: 'Point',
              coordinates: [-123.13419, 49.28657],
            },
            properties: {
  ...
  map.on('mousemove', 'cafes', (e) => {
    ...
    if (cafe.id !== hoveredcafeId) {
      ...
      const imageUrl =
        cafe.properties.Image || 'https://example.com/default-image.jpg';
