const map = new maplibregl.Map({
  container: 'map',
  style:
    'https://api.maptiler.com/maps/b7a80311-369e-46ab-9ba1-959248e92dfa/style.json?key=uq65uxq7TdtxVACz1H3W',
      ...
      features: [
        {
          ...
          geometry: {
            type: 'Point',
            coordinates: [36.20837, 34.009691],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [35.371071, 33.56699],
          },
        },
        {
          type: 'Feature',
