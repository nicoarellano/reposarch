...
map.on('load', () => {
  ...
  textOverlay.innerHTML =
    '<strong>My Cafe Guide of Montreal</strong><br>Explore the best local cafes!<br>Click on any icon for more';

  document.getElementById('map').appendChild(textOverlay);

  const points = [
    {
      coordinates: [-73.63063, 45.539661],
      properties: {
        name: 'OUI MAIS NON',
        type: 'Cafe',
        rating: '3.5/5',
    ...
    },
    {
      ...
      properties: {
        ...
        address:
          'British empire building, 200 Notre-Dame St W, Montreal, Quebec H2Y 1T3',
        website: 'tommycafe.ca',
      },
    },
    {
      coordinates: [-73.55336, 45.507259],
      properties: {
        name: 'CAFÉ OLIMPICO',
        type: 'cafe',
        rating: '4.5/5',
        comment:
          'amazing authentic italian coffee, definetely must try their caffe crema',
    ...
    },
    {
      ...
      properties: {
        ...
        address:
          '360 Rue Saint-Jacques, Montréal, QC H2Y 1P5419 R. Saint-Vincent, Montréal, QC H2Y 3A6',
    ...
    },
    {
      ...
      properties: {
        ...
        address:
          '6321 Trans-Canada Hwy bureau 148, Pointe-Claire, Quebec H9R 5A5',
    ...
    },
    {
      ...
      properties: {
        ...
        rating: '4.8/5',
        comment:
          'perfect spot for catching up with friends and authentic italian food and drinks',
    ...
    },
    {
      ...
      properties: {
        ...
        website:
          'www.barleybar.ca/_files/ugd/74ce94_29cee94750e444288b70b6a3de9ace73.pdf',
      },
    },
    {
    ...
    },
    {
      ...
      properties: {
        ...
        rating: '4/5',
        comment:
          'what else can i say other than they serve ice cream, banh mi sandwiches and own a tennis table',
