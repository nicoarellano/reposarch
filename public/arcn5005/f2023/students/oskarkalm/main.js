...
createText("- M.Arch Student at Carleton", 6, "0Xff000");
createText("- B.Eng from Carleton", 5, "0Xff000");
createText("- Enjoy Skiing and Motocross", 4, "0Xff000");
createText("- Amateur programmer", 3, "0Xff000");
...
function animate() {
  ...
  yellowCube.rotation.x += .25;
  yellowCube.rotation.y += .25;

  blueCube.rotation.x += .18;
  blueCube.rotation.y -= .18;

  redCube.rotation.x -= .1;
  redCube.rotation.y -= .1;
