import { chinatowns } from "/arcn5005/f2023/students/weixizhong/map/maplibre/chinatowns/chinatowns-list.js";
...
goTo.onclick = function () {
  switch (toggleGoTo) {
    case 0:
      ...
      map.setStyle('https://api.maptiler.com/maps/b8d97f5e-18db-42d0-9b96-bbd717462f5c/style.json?key=tsXILlKT33fdQiqtvY70');
      toggleGoTo = 1;
      break;
    case 1:
      ...
      map.setStyle('https://api.maptiler.com/maps/ec847ff3-3c4a-4e49-b950-d572fd38fcbc/style.json?key=tsXILlKT33fdQiqtvY70');
      toggleGoTo = 2;
      break;
    case 2:
