const places = {
    ...
    'features': [
        ...
        },
        {
            ...
            'properties': {
                'icon': 'Natural',
                'description': "<h2>Odzala-Kokoua Forest Massif</h2> <p>Significance: natural properties</p> <p>Country: Congo</p><p>Criterion: (ix)(x)</p>"
            },
            'geometry': {
                'type': 'Point',
        ...
        },
        {
            ...
            'properties': {
                'icon': 'Natural',
                'description': "<h2>Anticosti</h2> <p>Significance: natural properties</p> <p>Country: Canada</p><p>Criterion: (viii)</p>"
            },
            'geometry': {
                'type': 'Point',
        ...
        },
        {
            ...
            'properties': {
                'icon': 'Natural',
                'description': "<h2>Turanian deserts with cold winter</h2> <p>Significance: natural properties</p> <p>Country: Kazakhstan, Turkménistan</p><p>Criterion: (ix)(x)</p>"
            },
            'geometry': {
                'type': 'Point',
        ...
        },
        {
            ...
            'properties': {
                'icon': 'Natural',
                'description': "<h2>Nyungwe National Park</h2> <p>Significance: natural properties</p> <p>Country: Rwanda</p><p>Criterion: (x)</p>"
            },
            'geometry': {
                'type': 'Point',
        ...
        },
        {
            ...
            'properties': {
                'icon': 'Natural',
                'description': "<h2>'Uruq Bani Ma'arid</h2> <p>Significance: natural properties</p> <p>Country: Saudi Arabia</p><p>Criterion: (vii)(ix)</p>"
            },
            'geometry': {
                'type': 'Point',
        ...
        },
        {
            ...
            'properties': {
                'icon': 'Natural',
                'description': "<h2>Bale Mountains National Park</h2> <p>Significance: natural properties</p> <p>Country: Ethiopia</p><p>Criterion: (vii)(x)</p>"
            },
            'geometry': {
                'type': 'Point',
