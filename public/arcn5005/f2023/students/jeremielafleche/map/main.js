...
const map = new maplibregl.Map({
  container: "map",
  style:
    "https://api.maptiler.com/maps/basic/style.json?key=yyLFvKmMAkOmBAVbj4mk",
  zoom: 15,
...
const pointsOfInterest = [
  {
    name: "Roman Forum",
    image: "Images/Roman Forum.png",
    coordinates: [12.4853, 41.8925],
    iconSize: 0.2,
  },
  {
    name: "Spanish Steps",
    image: "Images/Spanish Steps.png",
    coordinates: [12.4828, 41.906],
    iconSize: 0.2,
  },
  {
    name: "Trevi Fountain",
    image: "Images/Trevi Fountain.png",
    coordinates: [12.4833, 41.9009],
    iconSize: 0.2,
  },
  {
    name: "Arch of Constantine",
    image: "Images/Arch of Constantine.png",
