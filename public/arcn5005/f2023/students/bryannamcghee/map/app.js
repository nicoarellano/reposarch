mapboxgl.accessToken =
  "pk.eyJ1IjoiYnJ5YW5uYW1jZ2hlZWVlZWUiLCJhIjoiY2xubnVpdjQzMDhqdTJybGdqOHRiNTByaCJ9.wcWkMFxVqseygG3InczbkQ";
...
map.on("style.load", () => {
  ...
  const markers = [
    ...
    {
      name: "Walk Along The Canal",
      color: "#DAF7A6",
      coordinates: [-75.6993, 45.4215],
    },
    {
      name: "Mayfair Theatre",
      color: "#DAF7A6",
      coordinates: [-75.6902, 45.3998],
    },
    {
      name: "Ha's Noodle House",
      color: "#D4AC0D",
      coordinates: [-75.7051, 45.4086],
    },
    { name: "Pizza Nerd", color: "#D4AC0D", coordinates: [-75.6984, 45.4153] },
    {
      name: "Collonande Pizza",
      color: "#D4AC0D",
      coordinates: [-75.6965, 45.4155],
    },
    { name: "La Cigale", color: "#D4AC0D", coordinates: [-75.8823, 45.5075] },
    {
      name: "Fariang Thai",
      color: "#D4AC0D",
      coordinates: [-75.6836, 45.3944],
    },
    { name: "Scone Witch", color: "#D4AC0D", coordinates: [-75.6925, 45.4217] },
    {
      name: "Midcentury Modern",
      color: "#7B241C",
      coordinates: [-75.6598, 45.3952],
    },
    { name: "Eat The Rich", color: "#7B241C", coordinates: [-75.6822, 45.45] },
  ...
  markers.forEach((marker) => {
    ...
    new mapboxgl.Marker({ color: marker.color, scale: 1 }) // ⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️ BRY, here you had scale 3, if you just leave it as 1, they look fine.
      .setLngLat(marker.coordinates)
      .setPopup(
        new mapboxgl.Popup().setHTML(
          `<div class="popup-content">${marker.name}</div>`
        )
      )
      .addTo(map);
  });
