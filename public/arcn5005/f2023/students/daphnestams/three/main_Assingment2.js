...
//Third Plane Geometry
const plane3geometry = new THREE.PlaneGeometry (8,8);
const plane3material = new THREE.MeshBasicMaterial ({color:0X707948, side: THREE.DoubleSide});
...
loadGLB("./models/studiomodel.glb", 7, 20, 4.5);
