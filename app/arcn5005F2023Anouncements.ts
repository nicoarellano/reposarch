 ...
 Enjoy your break and see you in 2 weeks!`,
  ...
  },
  {
    title:
      ...
      Remember that your submission must look different to my example. Now that you know how it works, please be creative and have fun with it (see for example Filipe's, Daphne's, Mikahla, Jenny, Cole, Evan, Jeremy, Keegan, Melanie, etc). There are great examples out there (that can also be improved if you want), take a look and learn from each other. Please revisit Assignment 1 and grab ideas from it, buttons, animations, background, etc. Make a good composition using both assignments. \
