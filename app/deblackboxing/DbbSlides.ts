...
export const dbbSlides: Slides = [
  ...
  },
  {
    ...
    ______________________________________________________________________________________\n\
          ...
          and alternatives to the existing tools we have and use.\n\
    ______________________________________________________________________________________\n\
  ...
  },
  {
    ...
    defined as opaque systems that can be understood in terms of their inputs and outputs, but whose processes are not accessible to users.\n\
    For example, proprietary software.\n\
    Our digital workflows are controlled by restrictive licenses and closed file formats,\n\
    transferring design control from the architect to the software vendors."
  },
  {
    id: "epistemic-object",
...
2) The development of an open-source digital tool\n\
______________________________________________________________________________________\n\
1) I will now move into the first one. The course.\n\
______________________________________________________________________________________\n\
2) The development of Canada’s Digital Twin."
  },
  {
    id: "conclusion",
    title: "Conclusion",
